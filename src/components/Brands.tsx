...
const Brands = () => {
  return (
    ...
    <h2 className="font-semibold text-base md:text-xl text-gray-200 tracking-wide text-center mb-2 relative z-40 px-8 md:px-0">Unmatched expertise in Web3 security and development</h2>
